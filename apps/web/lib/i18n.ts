...
export const ptBR = {
  ...
  notebooks: {
    ...
    link: {
      ...
      urlLabel: "Endereço",
      urlHint:
        "O endereço de uma página pública ou de um vídeo do YouTube. O servidor lê a página uma vez e guarda só o texto.",
      urlPlaceholder: "https://…",
      addSite: "Adicionar site",
      adding: "Lendo a página…",
      youtubeDetected: "Vídeo do YouTube: o texto da fonte é a transcrição.",
      pasteTranscript: "Colar a transcrição",
      transcriptLabel: "Transcrição",
      transcriptHint:
        "O YouTube não deixa um servidor buscar a transcrição. No vídeo, abra a descrição, clique em “Mostrar transcrição”, copie o texto e cole aqui — as marcações de tempo são removidas.",
      addVideo: "Adicionar vídeo",
      addingVideo: "Adicionando o vídeo…",
      videoTitle: (title: string) => `Vídeo: “${title}”`,
    },
    search: {
      label: "Pesquisar novas fontes",
      providersLabel: "Onde pesquisar",
      providers: {
        openalex: "Artigos",
        wikipedia: "Wikipédia",
        web: "Web",
      } as Record<string, string>,
      queryLabel: "O que pesquisar",
      queryPlaceholder: {
        openalex: "Ex.: fadiga em ligas de alumínio",
        wikipedia: "Ex.: aço inoxidável",
        web: "Ex.: seleção de materiais para bicicletas",
      } as Record<string, string>,
      submit: "Pesquisar",
      searching: "Pesquisando…",
      providerOff: (provider: string) => `${provider}: desligado`,
      results: "Resultados",
      resultsCount: (n: number) => (n === 1 ? "1 resultado" : `${n} resultados`),
      select: (title: string) => `Adicionar “${title}” ao caderno`,
      add: (n: number) => `Adicionar ${n}`,
      noText: "sem resumo — adicione o link aberto",
      ...
      empty: (q: string) => `Nada encontrado para “${q}”.`,
      webPrivacy:
        "Não pesquise com material sigiloso ou dados pessoais: a busca na web vai ao Google pelo plano gratuito do Gemini, que pode usar o conteúdo enviado para melhorar os modelos, e revisores humanos podem lê-lo.",
      suggestionsLabel: "Sugestões da Pesquisa Google",
    },
    reader: {
      origin: "Origem",
      license: "Licença",
      attribution: "Atribuição",
      noLicense: "licença não informada",
      transcriptOrigin: "Transcrição",
      transcriptOrigins: {
        colada: "Transcrição colada pelo aluno",
        automatica: "Transcrição obtida automaticamente",
      } as Record<string, string>,
      authors: "Autoria",
      year: "Ano",
      venue: "Publicado em",
      ...
      site: "Site",
      revision: "Revisão",
      fetchedAt: (date: string) => `obtida em ${date}`,
      openOrigin: (title: string) => `Abrir a origem de “${title}” em outra aba`,
    },
