...
export const ptBR = {
  ...
  synthesis: {
    ...
    kindSandwich: "Painel sanduíche (faces e núcleo)",
    recipeStep: "2. A receita",
    parentALabel: "Primeiro constituinte",
    parentASolidLabel: "Sólido",
    parentAFaceLabel: "Material das faces (duas faces simétricas)",
    parentBLabel: "Segundo constituinte",
    parentBCoreLabel: "Material do núcleo",
    ...
    faceThicknessLabel: "Espessura de cada face (t, em mm)",
    faceThicknessHint:
      "Espessura de cada uma das duas faces externas (t > 0). O painel é simétrico.",
    coreThicknessLabel: "Espessura do núcleo (c, em mm)",
    coreThicknessHint:
      "Espessura da camada interna do núcleo (c > 0). A espessura total será 2t + c.",
    totalThickness: (total: number) =>
      `Espessura total calculada do painel: ${total.toFixed(2)} mm`,
  ...
  battery: {
    ...
    cellSpecs: "Especificações da célula",
