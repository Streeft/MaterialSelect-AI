              ...
              <button
                ...
                className={cn(
                  ...
                  isCurrent
                    ...
                    : status === "done"
                      ? "border-edge bg-surface-raised text-ink hover:border-edge-strong"
                      : status === "blocked"
                        ? "border-dashed border-edge bg-surface-sunken text-ink-subtle"
                        : "border-edge bg-surface-raised text-ink-muted hover:border-edge-strong",
                )}
              >
                <span
                  aria-hidden
                  className={cn(
                    ...
                    status === "done"
                      ...
                      : isCurrent
                        ...
                        : "border-edge-strong text-ink-subtle",
                  )}
                >
