...
def test_every_canonical_unit_in_the_seeded_catalogue_admits_a_percentage() -> None:
    ...
    with SessionLocal() as db:
        units = [row[0] for row in db.execute(select(PropertyDefinition.canonical_unit)).all()]
