...
class ProcessClass(Base):
    ...
    #: Editorial text about the **family**, not about any material in it (P1-4) — the same pair
    #: ``MaterialClass`` carries, for the reason D-57 gives: a process family that
    #: stayed a bare label while a material class became a record would be exactly
    #: the asymmetry that decision argued against.
    #:
