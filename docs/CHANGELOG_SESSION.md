...
|---|---|---|---|---|
| [29](#sessão-29--250926--cadernos-o-notebooklm-dentro-do-app-e-o-gemini-gratuito) | 25/09/2026 | Cadernos, fase 1: fontes privadas, conversa citada com número conferido, guia, notas e cota, na tela de três painéis do NotebookLM (D-90); o Gemini gratuito como IA oficial, por configuração (D-91) | 1856 → 1906 | 505 → 530 |
...
**F1a — Gemini por configuração (D-91).** O Gemini fala o protocolo OpenAI, então
...
**F1b — o backend (D-90).** Oito tabelas (caderno, fonte, trecho, embedding,
...
**Números.** Backend 1856 → 1906; frontend 505 → 530; E2E + 1.
