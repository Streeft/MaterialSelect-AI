...
**O Battery Designer entregue fechou a faixa P4** ([D-69](docs/DECISIONS.md)): dimensionamento
...
Atinge 100% de cobertura das 31 capacidades funcionais do EduPack em nível ≥ 3.

1688 testes de backend (nenhum skip) e 353 de frontend, todos verdes. CI no
